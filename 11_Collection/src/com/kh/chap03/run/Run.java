...
public class Run {
	...
	public static void main(String[] args) {
		...
		// HashSet
		//Value값만 지정,index개념없음 == 순서보장 X, 중복 X
		...
		//HashSet => set에 새로운 요소를 추가할때마다
		//equals()와 hashCode()의 반환값을 기준으로 일치하는 요소가 있는지 판별함
		 ...
		 * 비교했을때 값이 일치하다면 ==> 동일객체로 판단(중복저장을 하지않음)
		 * 
		...
		*/
		...
		//HashSet -> 해시테이블
		//TreeSet -> 트리
		//개발자가 구체적인 자료구조를 모르더라도 반복을 시킬수있는 방법
		...
		//List계열, Set계열, 전부다 iterator()로 호출해서 반복시킬수있음
		//Map => 바로사용이 불가능
