 ...
 * - 스트림의 사이즈
 * 
 * 바이트 스트림 : 1Byte짜리 데이터가 이동 할 수 있는 통로
 * 			=> 입력(XXXInputStream) / 출력(XXXOutputStream)
 * 
 * 문자 스트림 : 2Byte짜리 데이터가 이동 할 수 있는 통로
 ...
 * 
 * 보조 스트림 : 기반스트림의 성능을 향상시키기위한 용도로 사용하는 스트림
 * 			=> 단독사용불가능(반드시 기반 스트림이 존재해야함)
