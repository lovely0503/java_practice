...
public class PuppyCare {
	...
	public void run() {
		...
		/*스캐너 타입의 변수선언*/Scanner sc = new Scanner(System.in);//스케너 객체 생성
		//sc.nextInt();
