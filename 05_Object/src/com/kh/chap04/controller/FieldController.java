 ...
 * 필드(멤버변수, 인스턴스 변수)
 * 
 * 생성시점 => new키워드를 사용해서 해당 객체를 생성하는 순간 heap에 할당
 * 소멸시점 => 객체가 소멸될때 =>GC이 동작을 안하면 OOM(Out Of Memory)발생
 * 
 * static필드(클래스 변수)
 * 
